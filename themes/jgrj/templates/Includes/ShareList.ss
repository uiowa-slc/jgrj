...
<ul class="share-list">
	<li class="share-list__item">
		<a href="https://twitter.com/intent/tweet?text={$AbsoluteLink}" title="Share on Twitter" target="_blank" class="share-list__link">
	...
	<li class="share-list__item">
		<a href="javascript:window.open('http://www.facebook.com/sharer/sharer.php?u={$AbsoluteLink}', '_blank', 'width=400,height=500');void(0);" title="Share on Facebook" class="share-list__link">
